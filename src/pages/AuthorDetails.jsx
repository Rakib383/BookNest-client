    ...
    return (
        ...
        <div >
            <div className="pt-10 sm:pt-16 pb-20 md:pb-28">
                <div className="w-80 sm:gap-8 sm:w-[560px] mx-auto flex flex-col sm:flex-row items-center card shadow-lg px-6 gap-3  justify-center bg-white dark:bg-gray-800 py-7 sm:py-14 sm:px-8">
