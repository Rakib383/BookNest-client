...
export const BorrowedBooksPage = () => {
    ...
    return (
        <div className=" mt-5 sm:pb-24">
            ...
            <p className="text-gray-600 dark:text-gray-400 font-semibold  md:text-[17px] px-3 w-96 md:w-[420px] mx-auto text-center">Review your borrowed books and keep track of the return dates.</p>
            {/* card container  */}
            <div className="flex flex-col max-w-6xl mx-auto sm:flex-row sm:flex-wrap justify-center items-center gap-7 md:gap-9 sm:px-5 mt-7 sm:mt-12 pb-14 px-3">
                ...
                {
                    books.map((book, idx) => (
                        <div key={idx} className="w-80  h-96  flex flex-col  items-center card shadow-lg px-6 gap-4 py-6 justify-center dark:bg-gray-700 bg-white">
