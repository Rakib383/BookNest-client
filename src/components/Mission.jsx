...
export const Mission = () => {
    ...
    return (
        <div className="text-center mt-9 pb-8 ">
            ...
            <p className="text-gray-600 dark:text-gray-400 font-semibold mt-2 md:text-[17px] lg:text-lg px-3 w-96 mx-auto">Empowering knowledge, inspiring growth, and fostering a love for learning.</p>
            {/* container  */}
            <motion.div ref={containerRef} className=" mt-8 sm:mt-12  flex flex-wrap items-center justify-center gap-5 md:gap-8  max-w-[760px] mx-auto">
                {/* card-1 */}
                <motion.div initial={{ x: -500,y:-300,opacity:0 }} animate={isInView && {x:0, y: 0,opacity:1}} transition={{ type: "spring", stiffness: 60, damping: 10 }} className=" dark:bg-gray-800 bg-white dark:text-white w-[340px] flex flex-col items-start px-6 py-8 rounded-lg gap-2 ">
                ...
                {/* card-2 */}
                <motion.div initial={{ x: 500,y:-300,opacity:0 }}  animate={isInView && {x:0, y: 0,opacity:1}} transition={{ type: "spring", stiffness: 60, damping: 10 }} className="bg-white dark:bg-gray-800  w-[340px] flex flex-col items-start px-4 py-8 rounded-lg gap-2 text-start ">
                ...
                {/* card-3 */}
                <motion.div initial={{ x: -500,y:300,opacity:0 }}  animate={isInView && {x:0, y: 0,opacity:1}} transition={{ type: "spring", stiffness: 60, damping: 10 }}  className="bg-white dark:bg-gray-800 w-[340px] flex flex-col items-start px-6 py-8 rounded-lg gap-2 ">
