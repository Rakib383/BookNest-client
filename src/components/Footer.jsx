...
export const Footer = () => {
    return (
        <div className="bg-base-200 pb-5 flex flex-col ">
            <footer className=" gap-4 flex flex-col items-center justify-between md:flex-row w-full text-base-content p-8 md:px-12 pb-3 max-w-6xl mx-auto ">
                ...
                <nav className="flex flex-col gap-1 text-center ">
                    <h6 className=" text-black font-bold text-base uppercase">Quick Links</h6>
                ...
                <nav className="flex flex-col gap-1 text-center">
                    <h6 className="text-black font-bold text-base uppercase">Categories</h6>
